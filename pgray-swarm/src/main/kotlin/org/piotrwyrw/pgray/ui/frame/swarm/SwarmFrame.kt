...
package org.piotrwyrw.pgray.ui.frame.swarm
...
import org.piotrwyrw.pgray.ui.frame.dialog.MessageDialog
import org.piotrwyrw.pgray.ui.frame.dialog.option
...
class SwarmFrame(
    ...
    frameTitle = "PGRay Swarm",
    initialWidth = INITIAL_WIDTH,
    initialHeight = INITIAL_HEIGHT,
    _resizable = true,
    closeOperator = DO_NOTHING_ON_CLOSE
) {
    ...
    override fun buildUI() {
        ...
        // TODO ----
        MessageDialog.show(
            DialogType.ERROR, "Title", "Message", this,
            option {
                label { "Confirm" }
                highlight { true }
                onClick { dialog -> dialog.dispose() }
            })
    }
